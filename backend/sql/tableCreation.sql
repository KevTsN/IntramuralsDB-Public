CREATE TABLE leagues (skillLevel int, numTeams int DEFAULT 0, sport varchar(12), maxTeams int, genders varchar(8), maxPlayers int, leagueID int, PRIMARY KEY (leagueID)); 
